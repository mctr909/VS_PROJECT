...
// contributed by Edward Calver
	...
	void stamp() {
	    mCirManager.stampVoltageSource(0, nodes[1], voltSource);
	}
	void doStep() {
	    double v0 = volts[1];
	    double out;
	    ...
	    double maxStep = slewRate * mCirManager.mDeltaTime * 1e9;
	    out = Math.max(Math.min(v0+maxStep, out), v0-maxStep);
	    mCirManager.updateVoltageSource(0, nodes[1], voltSource, out);
	}
